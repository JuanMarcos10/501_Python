#   SETs, conjuntos
"""
Un conjunto es una colección de elementos únicos que no está ordenada ni indexada.append()
En Python, los conjuntos se escriben entre llaves.
En un conjunto, no puede cambiar sus elementos, pero puede agregar nuevos elementos.
"""

#   Declaración:
mi_conjunto  = {"Juan", "Pepe", "Paco"}
mi_conjunto2 = {"Sara", "Beatriz", "Pilar"}

#   Otra forma de declararlo
mi_conjunto3 = set(("Salvador", "Marco", "Oscar")) 
print(mi_conjunto3)
...
print("Juan" in mi_conjunto)		#   Devuelve true o false
...
"""También puede usar el método pop() para eliminar un elemento, pero este método eliminará el último elemento. 
